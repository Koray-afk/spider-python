...
class Inproductutility {
  ...
  static origincheck(openerUrl) {
    try {
        ...
        var hostname = new URL(openerUrl).hostname.toLowerCase();
        ...
        var isTrustedSubdomain =
            subdomain.includes("dap") ||
            subdomain.includes("mics");

        var isTrustedOrganization = trustedOrganizations.some(org =>
            parts.includes(org)
        );

        return isTrustedSubdomain && isTrustedOrganization;
